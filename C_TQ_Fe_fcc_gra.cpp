#include "C_TQ_Fe_fcc_gra.h"
//*********************************
string C_TQ_Fe_fcc_gra::separator(50, '-');
char* C_TQ_Fe_fcc_gra::tc_installation_directory = "c:\\Program Files\\Thermo-Calc\\4.1\\";
char* C_TQ_Fe_fcc_gra::log_file_directory = "C:\\Users\\Marek\\AppData\\Local\\Temp\\!tq";
TC_STRING C_TQ_Fe_fcc_gra::used_database = "TCFE7";
TC_FLOAT C_TQ_Fe_fcc_gra::n = 1;
TC_FLOAT C_TQ_Fe_fcc_gra::p = 101325;
//*********************************
C_TQ_Fe_fcc_gra::C_TQ_Fe_fcc_gra(char *ele0, char *ele1, char *ele2, char *ele3, char *ele4,
...
//*********************************
//C_TQ_Fe_fcc_gra::C_TQ_Fe_fcc_gra(int n_ele, char *elements[]) : number_of_elements(n_ele + 1)
//{
//	initialization();
//	db_open();
//	//*********************************
...
//}
//*********************************
C_TQ_Fe_fcc_gra::~C_TQ_Fe_fcc_gra()
{
...
//*********************************
void C_TQ_Fe_fcc_gra::initialization()
{
...
//*********************************
void C_TQ_Fe_fcc_gra::db_open()
{
	tq_opdb(used_database, iwsg, iwse);
}
//*********************************
void C_TQ_Fe_fcc_gra::common_constructors_part()
{
...
//*********************************
void C_TQ_Fe_fcc_gra::input_elements_to_the_system()
{
...
//*********************************
void C_TQ_Fe_fcc_gra::set_system_phases()
{
	tq_rejph("*", iwsg, iwse);
	/*tq_resph("FCC LIQ BCC GRA CEM", iwsg, iwse);*/
	tq_resph("GRA FCC", iwsg, iwse);	// ------------------------------------------------- dodano do prog Jacka
}
//*********************************
void C_TQ_Fe_fcc_gra::get_data()
{
	tq_gdat(iwsg, iwse);
	if(tq_sg2err(&ierr) )
	{
...
//*********************************
void C_TQ_Fe_fcc_gra::get_elements_index()
{
	for(int i = 0; i < number_of_elements; i++)
	{
...
//*********************************
void C_TQ_Fe_fcc_gra::get_phases_number()
{
	tq_gnp(&number_of_phases, iwsg, iwse);
}
//*********************************
void C_TQ_Fe_fcc_gra::set_cond_p_n()
{
...
//*********************************
void C_TQ_Fe_fcc_gra::enter_conditions_ele_wtpc(TC_FLOAT ele0_wtpc, TC_FLOAT ele1_wtpc,
...
//*********************************
void C_TQ_Fe_fcc_gra::set_conditions_ele_wtpc()
{
	for(int i = 0; i < number_of_elements - 1; i++)
	{
...
//*********************************
void C_TQ_Fe_fcc_gra::enter_condition_temperature(TC_FLOAT temp)
{
	temperature = temp;
...
//*********************************
void C_TQ_Fe_fcc_gra::compute_equilibrium()
{
...
//*********************************
void C_TQ_Fe_fcc_gra::print_equilibrium()
{
	tq_sio("OUTPUT", 6);
...
//*********************************
void C_TQ_Fe_fcc_gra::get_phase_index(char *ph_name)
{
...
//*********************************
//void C_TQ_Fe_fcc_gra::remove_condition_temperature()
//{
//	tq_remc(num_condition_t, iwsg, iwse);
//}

double& C_TQ_Fe_fcc_gra::get_value(TC_FLOAT temp, TC_INT no_of_phase, TC_FLOAT ele0_wtpc, TC_FLOAT ele1_wtpc,		// ------------------------------------------------- dodano do prog Jacka
	TC_FLOAT ele2_wtpc, TC_FLOAT ele3_wtpc, TC_FLOAT ele4_wtpc, TC_FLOAT ele5_wtpc, TC_FLOAT ele6_wtpc,
	TC_FLOAT ele7_wtpc, TC_FLOAT ele8_wtpc)
{
