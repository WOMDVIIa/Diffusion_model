...
{
public:
	//C_TQ_Fe(int n_ele, char *elements[]);
	//C_TQ_Fe(char *ele0);
	//C_TQ_Fe(char *ele0, char *ele1);
	//C_TQ_Fe(char *ele0, char *ele1, char *ele2);
	//C_TQ_Fe(char *ele0, char *ele1, char *ele2, char *ele3);
	C_TQ_Fe(char *ele0, char *ele1 = 0, char *ele2 = 0, char *ele3 = 0, char *ele4 = 0,
					 char *ele5 = 0, char *ele6 = 0, char *ele7 = 0, char *ele8 = 0);
	C_TQ_Fe() {  cout << "Konstruktor domniemany klasy C_TQ_Fe" << endl; };
	~C_TQ_Fe();
	//********************************
